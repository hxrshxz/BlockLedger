        ...
        <div className="relative mx-auto h-[400px] max-w-4xl overflow-hidden rounded-[38px] border border-black/5 dark:border-white/20 bg-primary p-2 shadow-sm">
          ...
          <div className="relative z-10">
            <div className="mt-8 text-center">
              <h2 className="mb-6 text-4xl font-bold text-white">Every identity, asset and permission change on one verifiable record.</h2>
              <p className="mb-8 text-white/60">Smart India Hackathon · PS 26125 · Bharat Electronics Limited</p>
              <svg
                width="100"
                height="50"
                viewBox="0 0 100 50"
